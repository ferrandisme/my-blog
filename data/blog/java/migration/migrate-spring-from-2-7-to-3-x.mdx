---
title: 'Migrar de Spring Boot 2.7 a 3.x'
date: '2025-05-14'
...
Spring Boot 3 es una mejora significativa, ya que nos introduce grandes mejoras en aspectos como el rendimiento o la seguridad. También trae cambios como el de paquetería entre javax y jakarta. Vamos analizar las distintas partes del proceso de migración.
